...
const closedLadakhRing = [...ladakhRing, ...divideLine, ladakhRing[0]];
const closedJkRing = [...jkRing, ...divideLine.slice().reverse(), jkRing[0]];

const ladakhFeat = {
  type: 'Feature',
  geometry: { type: 'Polygon', coordinates: [closedLadakhRing] }
};

const jkFeat = {
  type: 'Feature',
  geometry: { type: 'Polygon', coordinates: [closedJkRing] }
};
...
// Custom refined centroids for clear visual typography
const customCentroids = {
  'Ladakh': [280, 50],
  'Jammu & Kashmir': [160, 65],
...
console.log('Successfully written updated src/data/indiaMapData.ts with separate Ladakh and J&K!');
