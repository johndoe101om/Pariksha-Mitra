...
const rawPaths = JSON.parse(fs.readFileSync('src/data/indiaGeoPaths.json', 'utf8'));

// Pastel Color map matching reference image
const colorPalette = {
  'Ladakh': '#92BCE6',
  ...
  'Andaman & Nicobar': '#92BCE6',
  'Puducherry': '#F4CB9A',
  'Lakshadweep': '#95D1DF',
  'Dadara & Nagar Havelli': '#AEE6E6',
  'Daman & Diu': '#AEE6E6'
};
