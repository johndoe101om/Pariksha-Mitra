...
// Let us create the exact J&K and Ladakh separation matching the user reference image
const jkFeature = geojson.features.find(f => f.properties?.NAME_1 === 'Jammu and Kashmir');
const ring = jkFeature.geometry.coordinates[0];

// The border between Ladakh and J&K:
// J&K is the south-western pocket below lat 35.15 and west of lng 76.5
// The dividing line curves from Himachal border (76.6, 32.9) northwest to (75.8, 34.0) around Kargil to (74.8, 34.8) up to (74.2, 35.2)
const dividerPoints = [
  [76.6, 32.9],
  [76.3, 33.3],
  [75.9, 33.8],
...
// Custom refined centroids matching user reference image
...
console.log('Successfully regenerated clean src/data/indiaMapData.ts!');
