...
for (let s = 0; s <= steps; s++) {
  const t = s / steps;
  // Natural curve along Kargil-Zanskar watershed
  const lng = ptNorth[0] * (1 - t) + ptSouth[0] * t + 0.45 * Math.sin(t * Math.PI);
...
// Export updated indiaMapData.ts
...
console.log('Successfully generated clean, seamless vector map data in src/data/indiaMapData.ts!');
